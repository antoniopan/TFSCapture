...
namespace UIDeal
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string sQueryTaskR1M = @"SELECT [System.Id], [System.Title], [Microsoft.VSTS.Common.Priority], [System.AssignedTo], [System.State], [MR.Requirement.ApplicativeProject], [System.NodeName], [UI.bug.keyword], [UI.Reserved], [UI.Bug.ExpectFixedBranch], [UI.ExpectedSolvedDate], [Microsoft.VSTS.Common.ResolvedDate], [Microsoft.VSTS.Common.ResolvedBy], [System.CreatedDate], [System.ChangedDate] FROM WorkItems WHERE [System.TeamProject] = 'Task'  AND (( [System.AreaPath] UNDER 'Task\SW\UIDeal_AWS'  AND  [MR.Requirement.ApplicativeProject] CONTAINS '[HSW-uWS-CT]' ) OR  [System.AreaPath] UNDER 'Task\SW\uInnovation'  OR  [System.AreaPath] UNDER 'Task\SW\MCSF1'  OR  [System.NodeName] = 'Report' ) AND  [System.WorkItemType] = 'Task'  AND  [Microsoft.VSTS.Common.Activity] = 'Improvement'  AND  [UI.Bug.ExpectFixedBranch] CONTAINS '[SWBU_69_SP4]'  AND  [System.NodeName] IN ('Heart', 'Liver Evaluation', 'Lung Nodule', 'Dual Energy Analysis', 'Dental Application', 'Colon Analysis', 'Body Perfusion', 'Bone Structure Analysis', 'Lung Density Analysis', 'Report', 'Review 4D', 'Dynamic Analysis_CT', 'Vessel Analysis_CT', 'Vessel Analysis_MR', 'Heart_Common', 'Vessel_Common', 'Vessel_Heart_Combined', 'FFR', 'Brain Perfusion_CT_3D')  AND  [System.State] IN ('Assigned', 'New')  AND  [System.AssignedTo] NOT CONTAINS 'CCB'  AND  [UI.Bug.ValidatedBranch] NOT CONTAINS '[SWBU_69_SP4]'  AND  [UI.bug.keyword] CONTAINS '[69SP4H2_R1M]' ORDER BY [System.State], [System.NodeName]";
            string sQueryTaskExpired = @"SELECT [System.Id], [System.Title], [Microsoft.VSTS.Common.Priority], [System.AssignedTo], [System.State], [MR.Requirement.ApplicativeProject], [System.NodeName], [UI.bug.keyword], [UI.Reserved], [UI.Bug.ExpectFixedBranch], [UI.ExpectedSolvedDate], [Microsoft.VSTS.Common.ResolvedDate], [Microsoft.VSTS.Common.ResolvedBy], [System.CreatedDate], [System.ChangedDate] FROM WorkItems WHERE [System.TeamProject] = 'Task'  AND (( [System.AreaPath] UNDER 'Task\SW\UIDeal_AWS'  AND  [MR.Requirement.ApplicativeProject] CONTAINS '[HSW-uWS-CT]' ) OR  [System.AreaPath] UNDER 'Task\SW\uInnovation'  OR  [System.AreaPath] UNDER 'Task\SW\MCSF1'  OR  [System.NodeName] = 'Report' ) AND  [System.WorkItemType] = 'Task'  AND  [Microsoft.VSTS.Common.Activity] = 'Improvement'  AND  [UI.Bug.ExpectFixedBranch] CONTAINS '[SWBU_69_SP4]'  AND  [System.NodeName] IN ('Heart', 'Liver Evaluation', 'Lung Nodule', 'Dual Energy Analysis', 'Dental Application', 'Colon Analysis', 'Body Perfusion', 'Bone Structure Analysis', 'Lung Density Analysis', 'Report', 'Review 4D', 'Dynamic Analysis_CT', 'Vessel Analysis_CT', 'Vessel Analysis_MR', 'Heart_Common', 'Vessel_Common', 'Vessel_Heart_Combined', 'FFR', 'Brain Perfusion_CT_3D')  AND  [System.State] IN ('Assigned', 'New')  AND ( [UI.ExpectedSolvedDate] < @today  OR  [UI.ExpectedSolvedDate] > '2020-10-29T00:00:00.0000000' ) AND  [System.AssignedTo] NOT CONTAINS 'CCB'  AND  [UI.Bug.ValidatedBranch] NOT CONTAINS '[SWBU_69_SP4]'  AND  [UI.bug.keyword] NOT CONTAINS 'H3' ORDER BY [System.State], [System.NodeName]";
            ...
            tfsTracker.ExtractTaskList(sQueryTaskR1M);
            tfsTracker.WriteExcelItemList("Improvement Task R1M");
