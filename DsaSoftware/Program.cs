...
namespace TestTFS
{
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            string sQueryAllTask = @"select [System.Id], [System.WorkItemType], [System.Title], [Microsoft.VSTS.Common.Priority], [System.AssignedTo], [System.State], [UI.ExpectedSolvedDate], [System.NodeName], [System.AreaPath], [UI.bug.keyword], [UI.Reserved], [System.CreatedBy], [System.CreatedDate] from WorkItems where [System.TeamProject] = 'Task' and [System.WorkItemType] = 'Task' and [System.AreaPath] under 'Task\XR\08_Loutang\Software' and not [System.NodeName] in ('SC', 'IC') and [Microsoft.VSTS.Common.Activity] = 'Improvement' and not [UI.Reserved] contains 'NoCMTC' order by [System.State], [System.AssignedTo], [Microsoft.VSTS.Common.Priority]";
